<template>
    <ion-page>
        ...
        <div class="list" v-for="produit in sales" :key="produit.id">
            <ion-item>
...
<script >
import { IonPage, IonItem, IonLabel, IonList, IonListHeader, modalController } from '@ionic/vue';
...
export default {
    ...
    methods: {
        ...
        showvente() {
          axios.get("http://127.0.0.1:8000/vente/").then((response) => {
